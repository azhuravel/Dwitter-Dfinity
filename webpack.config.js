...
module.exports = {
  ...
  output: {
    filename: "index.js",
    path: path.join(__dirname, "dist", "dwitter_assets"),
  },
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        {
          from: path.join(__dirname, "src", "dwitter_assets", "assets"),
          to: path.join(__dirname, "dist", "dwitter_assets"),
        },
      ],
    }),
  ...
  // proxy /api to port 8000 during developments
  devServer: {
    proxy: {
      "/api": {
